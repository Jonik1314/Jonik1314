...
def info_program(request, program_id):
    program = get_object_or_404(more_detailed, pk=program_id)
    title = program.more_detailed.title
    infa = card_info.objects.filter(program=program)
